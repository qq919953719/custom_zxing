...
import com.sinochem.zxinglib.R;
...
public class CaptureActivity extends AppCompatActivity implements Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         *
         */
        final int checked = ContextCompat.checkSelfPermission(CaptureActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
        if (checked == PackageManager.PERMISSION_GRANTED) {

        } else {
            ActivityCompat.requestPermissions(CaptureActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
        }
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                case REQUEST_CODE_SCAN_GALLERY:
                    ...
                    //对话框
                    AlertDialog dialog = new AlertDialog.Builder(this).setTitle("扫描结果：")//设置对话框的标题
